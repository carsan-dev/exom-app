...
class WeeklyDietPdfService {
      ...
      child: pw.Column(
        ...
        children: [
          ...
          if (diet == null)
            ...
            ...diet.meals.map(
              (meal) => _buildMeal(meal, labels: labels, bold: bold),
            ),
          ],
        ],
      ),
        ...
        children: [
          ...
          if (meal.ingredients.isNotEmpty)
            pw.Padding(
              ...
              child: pw.Text(
                '${labels.ingredients}: ${meal.ingredients.map(_ingredientText).join(', ')}',
  ...
  String _ingredientText(MealIngredientEntity ingredient) {
